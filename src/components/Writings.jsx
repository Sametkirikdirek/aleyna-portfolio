          ...
          <>
            ...
            <div className="order-2 md:order-none space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="font-sans font-medium text-lg md:text-xl text-ink group-hover:text-rose-700 dark:group-hover:text-amber-300 transition-colors">
                  {w.title}
                </h3>
                {w.tag && (
            ...
            <div className="order-3 md:order-none flex items-center gap-3 shrink-0 self-center md:self-start">
              ...
              {external ? (
                ...
                <span className="font-sans text-xs text-rose-700 dark:text-amber-300 font-medium group-hover:underline flex items-center gap-1">
                ...
                {personalWritings.map((w, i) => (
                  ...
                  >
                    <div>
                      ...
                      <h4 className="font-sans font-medium text-base md:text-lg text-ink group-hover:text-rose-700 dark:group-hover:text-amber-300 transition-colors leading-snug mb-2">
                        {w.title}
                      </h4>
