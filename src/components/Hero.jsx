      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto px-6 md:px-10 py-12 lg:py-24">
        <div className="grid lg:grid-cols-[1fr_0.9fr] gap-10 lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-start gap-6 text-left relative z-20">
            ...
            {/* CTA buttons */}
            <motion.div {...fadeUp(0.36)} className="flex flex-wrap gap-4 mt-1">
              <Link
                to="/gallery"
            ...
            {/* Social icons */}
            <motion.div {...fadeUp(0.48)} className="flex items-center gap-5 mt-2">
          ...
          {/* Sağ Taraf: GSAP Card Fan Carousel (3D Görsel Şölen) */}
          <motion.div {...fadeUp(0.2)} className="w-full flex justify-center items-center overflow-visible">
